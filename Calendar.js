function myFunction() {
    ...
    //-------------------------------------------------------------------------------------------Leap Day
    if (date === 29 && (n === "February")) {
        document.getElementById('feb29').style.color = "gold"
        document.getElementById('feb29').style.fontSize = "2em"
        document.body.style.backgroundColor = "#ff6a57";
    }
    ...
    if (date === 1 && (n === "December")) {
        ...
        document.body.style.backgroundColor = "#76ff63";
    }
